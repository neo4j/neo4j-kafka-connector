...
internal class Cypher25Renderer(neo4j: Neo4j) : Renderer {
  companion object {
    private val Neo4jVersion5 = Neo4jVersion(major = 5, minor = 0, patch = 0)
  }

  private val isCypher25PrefixSupported =
      canIUse(Cypher.explicitCypher25Selection()).withNeo4j(neo4j)
