...
class PatternTest {
  ...
  fun `should parse numeric literals correctly`() {
    ...
    assertContentEquals(
      listOf(
        NodePattern(
          emptySet(), mapOf("id1" to 0L, "id2" to -15L, "id3" to 5349L), emptySet(), emptySet())),
  ...
  fun `should parse bool literals`() {
    assertContentEquals(
      listOf(NodePattern(emptySet(), mapOf("id1" to true, "id2" to false), emptySet(), emptySet())),
  ...
  fun `should parse node patterns`() {
    ...
    assertContentEquals(
      ...
      Pattern.parse("({id: 5, *})"))
    assertContentEquals(
      listOf(NodePattern(emptySet(), mapOf("id" to 5L, "name" to "john"), setOf("*"), emptySet())),
    ...
    assertContentEquals(
      listOf(
        NodePattern(
          emptySet(), mapOf("id" to 5L, "name" to "john"), setOf("*"), setOf("skip1", "skip2"))),
  ...
  fun `relationship node patterns cannot contain property selectors`() {
    listOf(
      ...
      .forEach {
        ...
        assertEquals(
          "property selectors are not allowed in node part of relationship patterns", exception.msg)
      }
  }
}
