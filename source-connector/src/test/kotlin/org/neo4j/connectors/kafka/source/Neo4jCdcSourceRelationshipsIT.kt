...
class Neo4jCdcSourceRelationshipsAvroExtendedIT : Neo4jCdcSourceRelationshipsIT()

@KeyValueConverter(key = AVRO, value = AVRO, payloadMode = PayloadMode.COMPACT)
class Neo4jCdcSourceRelationshipsAvroCompactIT : Neo4jCdcSourceRelationshipsIT()

@KeyValueConverter(key = JSON_SCHEMA, value = JSON_SCHEMA, payloadMode = PayloadMode.EXTENDED)
class Neo4jCdcSourceRelationshipsJsonSchemaExtendedIT : Neo4jCdcSourceRelationshipsIT()

@KeyValueConverter(key = JSON_SCHEMA, value = JSON_SCHEMA, payloadMode = PayloadMode.COMPACT)
class Neo4jCdcSourceRelationshipsJsonSchemaCompactIT : Neo4jCdcSourceRelationshipsIT()

@KeyValueConverter(key = JSON_EMBEDDED, value = JSON_EMBEDDED, payloadMode = PayloadMode.EXTENDED)
class Neo4jCdcSourceRelationshipsJsonEmbeddedExtendedIT : Neo4jCdcSourceRelationshipsIT()

@KeyValueConverter(key = JSON_EMBEDDED, value = JSON_EMBEDDED, payloadMode = PayloadMode.COMPACT)
class Neo4jCdcSourceRelationshipsJsonEmbeddedCompactIT : Neo4jCdcSourceRelationshipsIT()

@KeyValueConverter(key = PROTOBUF, value = PROTOBUF, payloadMode = PayloadMode.EXTENDED)
class Neo4jCdcSourceRelationshipsProtobufExtendedIT : Neo4jCdcSourceRelationshipsIT()
