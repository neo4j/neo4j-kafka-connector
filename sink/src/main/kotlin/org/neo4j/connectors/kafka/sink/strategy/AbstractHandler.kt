...
abstract class AbstractHandler : SinkStrategyHandler {

  protected fun SinkMessage.valueFromConnectValue(): Any? {
    return fromConnectValue(valueSchema, value)
  }

  protected fun SinkMessage.keyFromConnectValue(): Any? {
    return fromConnectValue(keySchema, key)
  }

  protected fun SinkMessage.headerFromConnectValue(): Map<String, Any?> {
