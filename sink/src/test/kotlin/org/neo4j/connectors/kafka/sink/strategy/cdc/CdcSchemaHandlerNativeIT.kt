...
abstract class CdcSchemaHandlerNativeIT(eosOffsetLabel: String) :
  ...
  override fun neo4j() = neo4j
}

class CdcSchemaHandlerNativeWithEosOffsetIT : CdcSchemaHandlerNativeIT("__KafkaOffset") {}

class CdcSchemaHandlerNativeWithoutEosOffsetIT : CdcSchemaHandlerNativeIT("") {}
