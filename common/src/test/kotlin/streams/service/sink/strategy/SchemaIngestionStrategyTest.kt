...
class SchemaIngestionStrategyTest {
  ...
  fun `should create the Schema Query Strategy for mixed events`() {
    ...
    val constraints =
      listOf(
        Constraint(
          ...
          properties = linkedSetOf("name", "surname")))
    val nodeSchema =
      Schema(
      ...
      listOf(
        mapOf(
          "properties" to
            mapOf("name" to "Andrea", "surname" to "Santurbano", "comp@ny" to "LARUS-BA")),
        mapOf(
          "properties" to mapOf("name" to "Michael", "surname" to "Hunger", "comp@ny" to "Neo4j")))
    ...
    val expectedRelEvents =
      listOf(
        mapOf(
          "start" to mapOf("name" to "Andrea", "surname" to "Santurbano"),
  ...
  fun `should create the Schema Query Strategy for nodes`() {
    ...
    val txEvents =
      listOf(
        StreamsSinkEntity(cdcDataStart, cdcDataStart), StreamsSinkEntity(cdcDataEnd, cdcDataEnd))
  ...
  fun `should create the Schema Query Strategy for relationships`() {
        ...
        payload =
          RelationshipPayload(
            ...
            start =
              RelationshipNodeChange(
                id = "1",
                labels = listOf("User Ext", "NewLabel"),
                ids = mapOf("name" to "Michael", "surname" to "Hunger")),
            end =
              RelationshipNodeChange(
                id = "2",
                labels = listOf("Product Ext", "NewLabelA"),
                ids = mapOf("name" to "My Awesome Product")),
            after = RelationshipChange(properties = mapOf("since" to 2014)),
            before = null,
            label = "HAS BOUGHT"),
        schema = relSchema)
    ...
    val expectedRelEvents =
      listOf(
        mapOf(
          "start" to mapOf("name" to "Michael", "surname" to "Hunger"),
  ...
  fun `should create the Schema Query Strategy for relationships with multiple unique constraints`() {
    ...
    val constraintsList =
      listOf(
          Constraint(
            label = "User Ext",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("address")),
          Constraint(
            label = "User Ext",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("country")),
          Constraint(
            label = "User Ext",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("name", "surname")),
          Constraint(
            label = "User Ext",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("profession", "another_one")),
          Constraint(
            label = "Product Ext",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("code")),
          Constraint(
            label = "Product Ext",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("name")))
      ...
      StreamsTransactionEvent(
        ...
        payload =
          RelationshipPayload(
            ...
            start =
              RelationshipNodeChange(
                id = "1", labels = listOf("User Ext", "NewLabel"), ids = idsStart),
            end =
              RelationshipNodeChange(
                id = "2", labels = listOf("Product Ext", "NewLabelA"), ids = idsEnd),
            after = RelationshipChange(properties = mapOf("since" to 2014)),
            before = null,
            label = "HAS BOUGHT"),
        schema = relSchema)
    ...
    val expectedRelEvents =
      listOf(
        mapOf(
          "start" to mapOf("address" to "Baker Street"),
  ...
  fun `should create the Schema Query Strategy for relationships with multiple unique constraints and labels`() {
    ...
    val constraintsList =
      listOf(
          ...
          Constraint(
            label = "User AAA",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("another_two")),
          Constraint(
            label = "User Ext",
            type = StreamsConstraintType.UNIQUE,
            properties = linkedSetOf("name", "surname")),
      ...
      StreamsTransactionEvent(
        ...
        payload =
          RelationshipPayload(
            ...
            start =
              RelationshipNodeChange(
                id = "1", labels = listOf("User Ext", "User AAA", "NewLabel"), ids = idsStart),
            end =
              RelationshipNodeChange(
                id = "2", labels = listOf("Product Ext", "NewLabelA"), ids = idsEnd),
            after = RelationshipChange(properties = mapOf("since" to 2014)),
    ...
    val expectedRelEvents =
      listOf(
        mapOf(
          "start" to mapOf("another_two" to "Dunno"),
          "end" to mapOf("code" to 17294),
          "properties" to mapOf("since" to 2014)))
    assertEquals(expectedRelEvents, eventsRelList)
  }
