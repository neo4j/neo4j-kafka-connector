...
// Utility functions
const processReport = (type, report) => {
  ...
  return report.valid ? Promise.resolve() : Promise.reject();
};

const reportCommitMessage = (report) => processReport('Commit Message', report);

const reportPRTitle = (report) => processReport('PR Title', report);
  ...
  Promise.all([
    ...
    new Promise((resolve, reject) => {
      ...
      if (pr.body.length < minPRDescriptionLength) {
        fail(`:exclamation: Please include a description of your PR changes.`);
